...
import { Avatar, Box, Button, TextField, Typography, Paper, IconButton, InputAdornment, useTheme, Alert, CircularProgress, Link, } from "@mui/material";
...
export const LoginPage = () => {
    ...
    return (
        <>
                ...
                >
                    ...
                    <Box component="form" sx={{ mt: 4 }} onSubmit={handleSubmit}>
                        ...
                        <Box sx={{ textAlign: "right", mt: 1 }}>
                            <Link
                                onClick={() => setOpenResetDlg(true)}
                                underline="hover"
                                sx={{ fontSize: 14, color: theme.palette.primary.main, cursor: "pointer" }}
                            >
            ...
            <ResetPWDDialog open={openResetDlg} onClose={(b: boolean) => setOpenResetDlg(false)} />
        </>
    );
};
